...
class SnapshotManager:
    ...
    def load_latest_snapshot(
        ...
        if not snapshot_dirs:
            logger.info("No FAIM snapshots found under {root}", root=str(self._snapshot_root))
            return None
    ...
    def replay_journal_since(
        ...
        *,
        ...
        if self._journal_path is None:
            logger.info("SnapshotManager.replay_journal_since: no journal_path configured")
            return 0
