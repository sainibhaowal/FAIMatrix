...
export default function BillingPage() {
  return (
    <div className="space-y-6 pb-8 text-slate-100">
      <header>
        <h1 className="text-xl font-semibold">Resource Subscriptions</h1>
        <p className="mt-1 text-sm text-slate-400">Billing interface purified for native reconstruction.</p>
      </header>
