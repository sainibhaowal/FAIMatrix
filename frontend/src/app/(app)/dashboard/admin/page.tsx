...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-6">
      <GlassHeader
        title="Admin"
        subtitle="Restricted control plane for backups, runtime status, and graph repairs"
        icon={ShieldCheck}
        actions={
          <Button
            variant="outline"
      ...
      <div className="grid gap-4 xl:grid-cols-[1.5fr_1fr]">
        <section className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <StatusTile
              label="Admin auth"
              value={adminStatus?.runtime?.admin_key_configured ? "configured" : "missing"}
          ...
          {actionResult && (
            <div className="mt-4 rounded-2xl border border-white/10 bg-black/30 p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <Badge
                  variant={
                    actionResult.status === "error" ? "error" : "success"
                  }
                  size="sm"
                >
                  {actionResult.status}
      ...
      >
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5">
          ...
          <div className="mt-4 rounded-2xl border border-cyan-500/10 bg-cyan-500/5 p-4 text-sm text-cyan-50">
            This panel is the in-app destination. The same alerts can also be
            delivered to email for operator escalation.
          </div>
          ...
          {alertActionResult && (
            <div className="mt-4 rounded-2xl border border-white/10 bg-black/30 p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <Badge
                  variant={
                    alertActionResult.status === "error"
                      ? "error"
                      : "success"
                  }
                  size="sm"
