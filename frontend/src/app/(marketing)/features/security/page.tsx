  ...
  return (
    ...
    >
      ...
      <p className="text-slate-400 mb-6">
        ...
        deterministic UUIDv5 hashes. This means your User ID, Tenant ID, and Graph ID 
        are calculated from your email. This ensures absolute consistency across 
        signups and prevents identity fragments or duplicate accounts.
      </p>
