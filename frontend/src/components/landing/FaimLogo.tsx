...
export default function FaimLogo({ size = 40, showText = true, className = '' }: FaimLogoProps) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        <defs>
          ...
          <linearGradient id="faimGradientDark" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Background Circle */}
        <circle cx="24" cy="24" r="22" fill="url(#faimGradient)" opacity="0.15" />
        <circle cx="24" cy="24" r="22" stroke="url(#faimGradient)" strokeWidth="1.5" fill="none" opacity="0.5" />
