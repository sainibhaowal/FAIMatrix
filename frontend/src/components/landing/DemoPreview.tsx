        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-slate-400 leading-relaxed">
              Watch as FAIM automatically discovers connections between your
              documents, notes, and ideas. The knowledge graph grows and evolves
              in real-time, revealing insights you never knew existed.
            </p>
