          ...
          >
            ...
            <div className="flex-1 space-y-3 min-w-0">
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`text-[10px] font-black uppercase tracking-[0.25em] ${msg.role === "assistant" ? "text-primary-300" : "text-slate-400"}`}
                >
                  {msg.role === "assistant"
                    ? "FAIM SentineL"
                    : "Operator_Identity"}
              ...
              <div className="max-w-[90%] transition-colors duration-300">
                {msg.role === "user" ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {msg.queryData && (
                      <QueryAnswerCard queryData={msg.queryData} />
                    )}
                  </div>
                )}
              </div>
