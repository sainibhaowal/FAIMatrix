...
from core.cortex.cortexagi.connections.local import litert_connection
from core.cortex.cortexagi.connections.local import litert_connection_config
from core.cortex.cortexagi.connections.local import litert_server
from core.cortex.cortexagi.connections.local import local_openai_connection_config
...
class LiteRTConnectionTest(unittest.IsolatedAsyncioTestCase):
  ...
  @mock.patch(
      "core.cortex.cortexagi.connections.local.local_connection.LocalConnectionStrategy.__aenter__"
  )
  ...
  def test_litert_config_validation_missing_model(self):
    ...
    with self.assertRaises(types.FAIMCortexAGIValidationError):
  ...
  @mock.patch(
      "core.cortex.cortexagi.connections.local.litert_connection._check_gpu_acceleration_available"
  )
  ...
  def test_litert_logging_verbose_when_debug_enabled(self):
    ...
    with mock.patch.object(litert_connection, "litert_lm") as mock_litert_lm:
      ...
      mock_litert_lm.set_min_log_severity = mock.MagicMock()
      logger = logging.getLogger("core.cortex.cortexagi")
