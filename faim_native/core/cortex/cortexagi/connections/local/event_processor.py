...
from core.cortex.cortexagi.connections.local import types as local_types
from core.cortex.cortexagi.connections.local.hook_router import HookRouter
from core.cortex.cortexagi.connections.local.local_connection_config import BUILTIN_TOOL_PROTO_FIELDS
from core.cortex.cortexagi.connections.local.local_connection_config import normalize_wire_path
from core.cortex.cortexagi.connections.local.local_connection_config import WIRE_PATH_ARGUMENT_KEYS
from core.cortex.cortexagi.hooks import hook_runner as h_runner
from core.cortex.cortexagi.hooks import hooks
      ...
      if (
        ...
        if tsu.HasField("error"):
          await self.step_queue.put(
              types.FAIMCortexAGIExecutionError(tsu.error)
          )
        self.is_idle.set()
        ...
        await self.step_queue.put(types.FAIMCortexAGIExecutionError(msg))
        self.is_idle.set()
        await self.step_queue.put(IDLE_SENTINEL)
      return
