...
"""Base definitions for FAIM Cortex AGI Engine Hooks v2.
...
from core.cortex.cortexagi.types import AskQuestionInteractionSpec
from core.cortex.cortexagi.types import HookResult
from core.cortex.cortexagi.types import QuestionHookResult
from core.cortex.cortexagi.utils import state as state_module
