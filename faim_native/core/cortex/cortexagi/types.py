...
"""Type definitions for FAIM Cortex AGI Engine.
...
from core.cortex.cortexagi.models import GeminiAPIEndpoint
from core.cortex.cortexagi.models import GeminiModelOptions
from core.cortex.cortexagi.models import ModelEndpoint
from core.cortex.cortexagi.models import ModelTarget
from core.cortex.cortexagi.models import ModelType
from core.cortex.cortexagi.models import ThinkingLevel
from core.cortex.cortexagi.models import VertexEndpoint
...
__all__ = [
    ...
    "FAIMCortexAGIConnectionError",
    "FAIMCortexAGICancelledError",
    "FAIMCortexAGIValidationError",
    "FAIMCortexAGIExecutionError",
    "StreamChunk",
    "Thought",
    "Text",
    "ChatResponse",
...
class FAIMCortexAGIConnectionError(Exception):
  """Base class for connection errors in the FAIM Cortex AGI Engine.
...
class FAIMCortexAGICancelledError(asyncio.CancelledError):
...
class FAIMCortexAGIExecutionError(Exception):
...
class FAIMCortexAGIValidationError(Exception):
  ...
  def _from_pydantic(
    ...
    Returns:
      An FAIMCortexAGIValidationError wrapping the Pydantic error.
    """
