...
from core.cortex.cortexagi import agent
from core.cortex.cortexagi import types
from core.cortex.cortexagi.connections import local as local_connection
from core.cortex.cortexagi.connections.local import local_connection as lc_module
...
from core.cortex.cortexagi.models import DEFAULT_IMAGE_GENERATION_MODEL
...
class AgentTest(unittest.IsolatedAsyncioTestCase):
  ...
  @mock.patch(
      "core.cortex.cortexagi.connections."
  ...
  @mock.patch(
      "core.cortex.cortexagi.connections.local.local_connection.LocalConnectionStrategy"
  )
  @mock.patch.object(conversation.Conversation, "create")
