...
class TestEncodingDeterminism:
    ...
    def test_vectorize_text_deterministic(self):
        ...
        v1, s1, o1 = vectorize_text(text)
        v2, s2, o2 = vectorize_text(text)
    ...
    def test_whitespace_normalization(self):
        ...
        v1, _, _ = vectorize_text("hello   world")
        v2, _, _ = vectorize_text("hello world")
    ...
    def test_empty_text_deterministic(self):
        ...
        v1, s1, o1 = vectorize_text("")
        v2, s2, o2 = vectorize_text("")
