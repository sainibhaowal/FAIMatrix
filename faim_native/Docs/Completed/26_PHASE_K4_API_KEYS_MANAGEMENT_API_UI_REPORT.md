...
- this page is for verified tenant users and programmatic integrations
- it is not an admin-only console
- the live app does not expose a separate admin dashboard
